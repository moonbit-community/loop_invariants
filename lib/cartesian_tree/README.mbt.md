...
test "basic rmq" {
  ...
  debug_inspect(@cartesian_tree.range_min(arr, 1, 3), content="Some(1)")
  debug_inspect(@cartesian_tree.range_min(arr, 0, 2), content="Some(2)")
}
```
...
test "duplicates" {
  ...
  debug_inspect(@cartesian_tree.range_min(arr, 0, 1), content="Some(5)")
  debug_inspect(@cartesian_tree.range_min(arr, 0, 2), content="Some(2)")
}
```
...
test "ascending and descending" {
  ...
  debug_inspect(@cartesian_tree.range_min(asc, 1, 3), content="Some(2)")
  debug_inspect(@cartesian_tree.range_min(desc, 1, 3), content="Some(1)")
}
```
...
test "invalid range" {
  ...
  debug_inspect(@cartesian_tree.range_min(arr, -1, 1), content="None")
  debug_inspect(@cartesian_tree.range_min(arr, 2, 1), content="None")
  debug_inspect(@cartesian_tree.range_min(arr, 0, 10), content="None")
}
```
