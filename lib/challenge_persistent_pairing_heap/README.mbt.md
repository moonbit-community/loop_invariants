...
test "pairing heap basic" {
  ...
  debug_inspect(
    @challenge_persistent_pairing_heap.find_min(h3),
    content="Some(3)",
  )
  ...
  debug_inspect(
    @challenge_persistent_pairing_heap.find_min(h4),
    content="Some(6)",
  )
}
```
...
test "pairing heap persistence" {
  ...
  debug_inspect(@challenge_persistent_pairing_heap.find_min(h0), content="None")
  debug_inspect(
    @challenge_persistent_pairing_heap.find_min(h1),
    content="Some(10)",
  )
  debug_inspect(
    @challenge_persistent_pairing_heap.find_min(h2),
    content="Some(2)",
  )
}
```
