...
test "persistent hash map" {
  ...
  debug_inspect(@challenge_persistent_hash_map.size(map3), content="2")
}
```
...
test "persistent hash map collisions" {
  ...
  debug_inspect(@challenge_persistent_hash_map.size(map3), content="3")
}
```
...
test "persistent hash map update" {
  ...
  debug_inspect(@challenge_persistent_hash_map.size(map2), content="1")
}
```
