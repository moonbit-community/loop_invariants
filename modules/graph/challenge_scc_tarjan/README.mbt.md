...
test "scc tarjan cycle" {
  ...
  debug_inspect(comp[0] == comp[1] && comp[1] == comp[2], content="true")
  debug_inspect(comp[3] != comp[4], content="true")
}
```
...
test "scc tarjan dag" {
  ...
  debug_inspect(comp, content="[3, 2, 1, 0]")
}
```
...
test "scc tarjan isolated" {
  ...
  debug_inspect(comp[0] != comp[1], content="true")
}
```
